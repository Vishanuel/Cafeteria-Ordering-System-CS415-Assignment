...
(24, 1234, '2020-05-06', '2020-05-06', 'Approved', 5, 'payroll', NULL);
...
(3, 'Spicy chicken and chips', 'Spicy fried chicken with chips.', 8, '9.00', 1, 'dist/img/restaurant/Fried-Chicken_2.jpg'),
(4, 'French Fries', 'Golden brown french fried local potatoes.', 15, '10.00', 1, 'dist/img/restaurant/french-fries.jpg'),
(5, 'Vegetarian Sandwich', 'Double layer sandwich with fillings such as cheese, lettuce, tomatoes, grilled pineapple and mayo.', 6, '11.00', 1, 'dist/img/restaurant/Vegeterian-Sandwich.jpg');
...
CREATE TABLE IF NOT EXISTS `ordered_ingredient` (
  ...
  KEY `Cos_Order_Num` (`Cos_Order_Num`,`Ingredient_ID`),
  KEY `Ingredient_ID` (`Ingredient_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1;
