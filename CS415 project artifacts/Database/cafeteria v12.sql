...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2020 at 02:30 AM
...
(23, 1234, '2020-05-06', '2020-05-20', 'Pending Delivery', 5, 'payroll', NULL),
(24, 1234, '2020-05-06', '2020-05-06', 'Pending Delivery', 5, 'payroll', NULL),
(25, 1256, '2020-05-06', '2020-05-06', 'orderingg', 9, 'cash', NULL),
(26, 1234, '2020-05-06', '2020-05-06', 'Approved', 11, 'payroll', NULL),
(27, 1234, '2020-05-06', '2020-05-06', 'Approved', 11, 'payroll', NULL);
...
(1, 'Dhal Bhaat', 'Nepalese dal bhat (dal bat or dhal bhat), composed of white rice (bhat) and lentils (dal) and is accompanied by a vegetable curry (tarkari), a mixture of spicy vegetables (pickles) and greens (sak).', 70, '5.00', 1, 'dist/img/restaurant/dal-bhat-1.jpeg'),
(2, 'Fried Chicken', 'This dish consists of 8 chicken pieces which have been coated in a seasoned batter and deep fried. The breading adds a crisp coating or crust to the exterior of the chicken while retaining juices in the meat.', 15, '6.00', 1, 'dist/img/restaurant/61589069.jpg'),
(3, 'Spicy chicken and chips', 'Spicy fried chicken with chips.', 7, '9.00', 1, 'dist/img/restaurant/Fried-Chicken_2.jpg'),
(4, 'French Fries', 'Golden brown french fried local potatoes.', 15, '10.00', 1, 'dist/img/restaurant/french-fries.jpg'),
(5, 'Vegetarian Sandwich', 'Double layer sandwich with fillings such as cheese, lettuce, tomatoes, grilled pineapple and mayo.', 3, '11.00', 1, 'dist/img/restaurant/Vegeterian-Sandwich.jpg');
...
(1234, 'Test Patron', '@gmail.com', '9999999', 'Labasa', 0, 0, 1),
...
--
-- Indexes for table `meal_subscription`
--
ALTER TABLE `meal_subscription`
  ADD PRIMARY KEY (`MealSubs_ID`),
  ADD KEY `fk_meal_subs_employee_id` (`Employee_ID`),
  ADD KEY `meal_subs_menu_food_item_id` (`Menu_Food_Item_ID`);
...
ALTER TABLE `ordered_ingredient`
  ...
  ADD KEY `Cos_Order_Num` (`Cos_Order_Num`,`Ingredient_ID`),
  ADD KEY `Ingredient_ID` (`Ingredient_ID`);
...
--
ALTER TABLE `cos_order`
  MODIFY `Cos_Order_Num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `delivery_instruction`
--
ALTER TABLE `delivery_instruction`
  MODIFY `D_Instruction_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `delivery_request`
--
ALTER TABLE `delivery_request`
  MODIFY `D_Request_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- AUTO_INCREMENT for table `meal_subscription`
--
ALTER TABLE `meal_subscription`
  MODIFY `MealSubs_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `menu_food`
  MODIFY `Menu_Food_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `menu_food_item`
--
ALTER TABLE `menu_food_item`
  MODIFY `Menu_Food_Item_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `ordered_food_item`
  MODIFY `Ordered_Food_Item_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `ordered_ingredient`
--
ALTER TABLE `ordered_ingredient`
  MODIFY `Ordered_Ingredient_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `ordered_special`
--
ALTER TABLE `ordered_special`
  MODIFY `Ordered_Special_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `patron`
--
ALTER TABLE `patron`
  MODIFY `Employee_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1257;
...
--
ALTER TABLE `special_food`
  MODIFY `Special_Food_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
