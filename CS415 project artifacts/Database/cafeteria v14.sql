...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jun 15, 2020 at 03:46 PM
...
--
-- Error reading structure for table cafeteria.delivery_request: #1932 - Table 'cafeteria.delivery_request' doesn't exist in engine
-- Error reading data for table cafeteria.delivery_request: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `cafeteria`.`delivery_request`' at line 1
...
INSERT INTO `meal_subscription` (`MealSubs_ID`, `Employee_ID`, `Menu_Food_Item_ID`, `Food_Item_Qty`, `Total_Price`, `Meal_Time`, `Meal_Type`, `Meal_Status`, `Day`, `Meal_Subscription_Status`, `Meal_Subscription_Start_Date`, `Meal_Subscription_End_Date`, `Meal_Subscription_Frequency`, `Meal_Subscription_Method`) VALUES
(9, 1256, 1, 1, 5, '8 am', 'Breakfast', 'Pending Delivery', 'Monday', 'Active', '2020-05-17', '2020-05-27', 'Daily', 'Delivery'),
(10, 1256, 3, 2, 18, '1 pm', 'Lunch', 'Pending Delivery', 'Thursday', 'Active', '2020-05-17', '2020-07-17', 'Weekly', 'Delivery'),
(11, 1256, 1, 1, 5, '8 am', 'Breakfast', 'Pending', 'Monday', 'Active', '2020-05-17', '2020-06-17', 'Daily', 'Pickup'),
(12, 1256, 3, 6, 54, '1 pm', 'Lunch', 'Delivered', 'Thursday', 'Active', '2020-05-17', '2020-06-17', 'Weekly', 'Delivery'),
(13, 1256, 2, 14, 84, '1 pm', 'Lunch', 'Delivered', 'Monday', 'Active', '2020-05-17', '2020-08-17', 'Monthly', 'Delivery');
...
(1, 'Dhal Bhaat', 'Nepalese dal bhat (dal bat or dhal bhat), composed of white rice (bhat) and lentils (dal) and is accompanied by a vegetable curry (tarkari), a mixture of spicy vegetables (pickles) and greens (sak).', 5, '5.00', 0, 1, 'dist/img/restaurant/dal-bhat-1.jpeg'),
...
(3, 'Spicy Chicken and Chips', 'Spicy fried chicken with chips.', 5, '9.00', 0, 1, 'dist/img/restaurant/Fried-Chicken_2.jpg'),
(4, 'French Fries', 'Golden brown french fried local potatoes.', 8, '10.00', 1, 1, 'dist/img/restaurant/french-fries.jpg'),
(5, 'Vegetarian Sandwich', 'Double layer sandwich with fillings such as cheese, lettuce, tomatoes, grilled pineapple and mayo.', 4, '11.00', 1, 1, 'dist/img/restaurant/Vegeterian-Sandwich.jpg'),
...
(13, 'Egg Rice', 'fried egg with rice', 5, '3.00', 1, 1, 'dist/img/restaurant/egg-rice.jpg');
...
(1, 'Test Patron', 'is314lcnotif@gmail.com', 'Patron', NULL, '$2y$10$rlJYGJBXXGbIP/UEwdzKmeVMu71srbLW58u9Wjjeg.4vNDhXgOhEO', NULL, NULL, NULL, 0),
...
(3, 'Rakess', 'cs324assignment@gmail.com', 'Patron', '2020-03-09 12:00:00', '$2y$10$rlJYGJBXXGbIP/UEwdzKmeVMu71srbLW58u9Wjjeg.4vNDhXgOhEO', NULL, NULL, '2020-06-15 03:38:55', 4),
...
(7, 'Johnny', 'johnny@gmail.com', 'Student', NULL, '$2y$10$rlJYGJBXXGbIP/UEwdzKmeVMu71srbLW58u9Wjjeg.4vNDhXgOhEO', NULL, NULL, '2020-06-15 03:08:09', 0);
