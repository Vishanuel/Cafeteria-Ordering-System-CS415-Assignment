...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2020 at 01:47 AM
...
(1, 'Dhal Bhaat', 'Dhal and rice', -1, '5.00', 0),
(2, 'Fried Chicken', 'Test', 0, '6.00', 0),
(3, 'Spicy chicken and chips', 'Spicy fried chicken with chips', 9, '9.00', 0);
...
--
ALTER TABLE `cos_order`
  MODIFY `Cos_Order_Num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `menu_food_item`
  MODIFY `Menu_Food_Item_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ordered_food_item`
  MODIFY `Ordered_Food_Item_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
