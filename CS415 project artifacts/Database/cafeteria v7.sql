...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 04, 2020 at 09:19 PM
...
(1, 'Dhal Bhaat', 'Nepalese dal bhat (dal bat or dhal bhat), composed of white rice (bhat) and lentils (dal) and is accompanied by a vegetable curry (tarkari), a mixture of spicy vegetables (pickles) and greens (sak).', 72, '5.00', 1, 'dist/img/restaurant/dal-bhat-1.jpeg'),
