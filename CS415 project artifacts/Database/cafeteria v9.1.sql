...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2020 at 11:11 AM
...
INSERT INTO `ordered_ingredient` (`Ordered_Ingredient_ID`, `Cos_Order_Num`, `Ingredient_ID`) VALUES
(13, 22, 1),
(14, 22, 2),
(12, 22, 5);
...
ALTER TABLE `ordered_ingredient`
  ADD CONSTRAINT `ordered_ingredient_ibfk_1` FOREIGN KEY (`Cos_Order_Num`) REFERENCES `cos_order` (`Cos_Order_Num`) ON DELETE CASCADE ON UPDATE CASCADE,
