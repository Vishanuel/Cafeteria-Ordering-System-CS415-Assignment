...
INSERT INTO `menu_food_item` (`Menu_Food_Item_ID`, `Food_Name`, `Food_Desc`, `Quantity`, `Price`, `Food_Pic`) VALUES
(1, 'Dhal Bhaat', 'Nepalese dal bhat (dal bat or dhal bhat), composed of white rice (bhat) and lentils (dal) and is accompanied by a vegetable curry (tarkari), a mixture of spicy vegetables (pickles) and greens (sak).', 72, '5.00', 'dist/img/restaurant/dal-bhat-1.jpeg'),
(2, 'Fried Chicken', 'This dish consists of 8 chicken pieces which have been coated in a seasoned batter and deep fried. The breading adds a crisp coating or crust to the exterior of the chicken while retaining juices in the meat.', 15, '6.00', 'dist/img/restaurant/61589069.jpg'),
(3, 'Spicy chicken and chips', 'Spicy fried chicken with chips.', 8, '9.00', 'dist/img/restaurant/Fried-Chicken_2.jpg'),
(4, 'French Fries', 'Golden brown french fried local potatoes.', 15, '10.00', 'dist/img/restaurant/dal-bhat-1.jpeg'),
(5, 'Vegetarian Sandwich', 'Double layer sandwich with fillings such as cheese, lettuce, tomatoes, grilled pineapple and mayo.', 6, '11.00', 'dist/img/restaurant/dal-bhat-1.jpeg');
