			...
			<nav class="navbar navbar-static-top" style="background: rgba(200, 200, 200, 0.6);">
				<div class="container">
					...
					<ul class="nav navbar-nav">
						<li class="active"><a href="{{URL::to('menu_manager')}}">Home</a></li>
						<li class="active"><a href="{{URL::to('menu')}}">Menus</a></li>
						{{-- <li class="active"><a href="{{URL::to('menu/create')}}">Create Menu </a></li> --}}
						<li class="active"><a href="{{URL::to('specialmenu')}}">Special Menus</a></li>
						<li class="active"><a href="{{URL::to('item')}}"> Menu Items</a></li>
						<li class="active"><a href="{{URL::to('recipe')}}"> Recipes</a></li>
						<li class="active"><a href="{{URL::to('ingredient')}}">Item Ingredients</a></li>
						{{-- <li><a href="#">Link</a></li>
						<li class="dropdown">
