...
<body class="hold-transition skin-blue layout-top-nav">
    <div class="wrapper">
        ...
        <header class="main-header"
            style="background: url('../dist/img/restaurant/login22.jpg') center center ;background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="{{URL::to('menu')}}">Menus<span
                                        class="sr-only">(current)</span></a></li>
                            {{-- <li class="active"><a href="{{URL::to('menu/create')}}">Create Menu <span
                                class="sr-only">(current)</span></a></li> --}}
                            <li class="active"><a href="{{URL::to('specialmenu')}}">Special Menus<span
                                        class="sr-only">(current)</span></a></li>
                            <li class="active"><a href="{{URL::to('item')}}"> Menu Items<span
                                        class="sr-only">(current)</span></a></li>
                            <li class="active"><a href="{{URL::to('ingredient')}}">Item Ingredients<span
                                        class="sr-only">(current)</span></a></li>
                            {{-- <li><a href="#">Link</a></li>
						<li class="dropdown">
    ...
    <script>
        ...
        $('#addfood').click(function () {
            $('<div class="col-md-12"><a type="button" id="removefood' + count +
                '" class="btn bg-maroon btn-flat margin">Remove item</a></div>').prependTo('#orderform');
            $('<div id="priced' + count +
                '" class="form-group col-md-2"><label>Price ($)</label><input type="number" class="form-control" id="price' +
                count + '" name="price' + count + '" Required readonly value=""></div>').prependTo(
                '#orderform');
            $('<div id="qavailabled' + count +
                '" class="form-group col-md-2"><label>Max Quantity Available</label><input type="number" class="form-control" id="qavailable' +
                count + '" name="qavailable' + count + '" Required readonly value=""></div>').prependTo(
                '#orderform');
            $('<div id="quantityd' + count +
                    '" class="form-group col-md-2"><label>Quantity</label><input type="number" class="form-control" id="quantity' +
                    count + '" name="quantity' + count + '" max="" min="1" Required value="1"></div>')
                .prependTo('#orderform');
            $('<div id="food_itemd' + count +
                '" class="form-group col-md-6"><label>Food Item</label><select class="food form-control select2" id="food_item' +
                count + '" name="food_item' + count +
                '" style="width: 100%;" Required placeholder="Select food"></select>').prependTo(
                '#orderform');
