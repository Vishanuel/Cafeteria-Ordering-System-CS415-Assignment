    ...
    <nav class="navbar navbar-static-top" style="background: rgba(200, 200, 200, 0.6);">
      <div class="container" >
        <div class="navbar-header">
          ...
          <a type="button" id="backbutton" class="navbar-brand" style="display:block;" onclick="backbutton();" ><i class="glyphicon glyphicon-menu-left" style="width:10;"></i></a><span class="navbar-brand"><b >Cafeteria </b>Ordering System</span>
...
<!--<div  width="90%" style="text-align: center;  height:1px; color: white; background: rgba(200, 200, 200, 1) center center;"></div>-->
  <div class="content-wrapper" data-barba="container" data-barba-namespace="home">
	...
	@endif
	<div width="100%" style="position:absolute;padding: 100 auto;height:125px;bottom:100;left:0;right:0;background: url('../dist/img/restaurant/login22.jpg') center center ;background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
		<div width="100%" style="padding: 100 auto;height:125px;bottom:100;left:0;right:0;background: rgba(200, 200, 200, 0.6);background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
		<hr width="90%" style="margin-bottom:0; border:none;margin-top:0; height:1px; background: rgba(255, 255, 255, 0.5) center center;">
		</div>
	</div>
	@yield('content')
    </div>
