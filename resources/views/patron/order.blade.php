    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box loading box-success">
                    ...
                    <div id="box" class="box-body">
                        <form id="orderform" role="form" method="POST" action="{{action('OrderController@store')}}"
                            ...
                            <div id="food_itemd1" class="form-group col-md-6">
                                ...
                                <select class="food form-control select2" id="food_item1" name="food_item1"
                                    style="width: 100%;" Required placeholder="Select food">
                                    <option disabled>Select food</option>
                                    @foreach ($foods as $food )
                                    <option Required
                                        value="{{ $food->Menu_Food_Item_ID}} {{$food->Quantity}} {{$food->Price}}">
						...
						<div class="optional1" id="hello{{$items[$i]->Menu_Food_Item_ID}}" type="hidden">
                                ...
                                @for($j=0;$j<count($ingredients[$i]);$j++) <div class="checkbox" id="check1"><input
                                        type="checkbox" id="optional1" class="minimal" name="optional1[{{$i}}][]"
            ...
            <div id="quantityd1" class="form-group col-md-2">
                ...
                <input type="number" class="form-control" id="quantity1" name="quantity1" max="" min="1" Required
                    value="1">
            </div>
            <div id="qavailabled1" class="form-group col-md-2">
                <label>Max Quantity Available</label>
                <input type="number" class="form-control" id="qavailable1" name="qavailable1" Required readonly
                    value="">
            </div>
            ...
            <div id="specialfoods123" class="form-group col-md-6">
                <label>Special</label>
                <select class="food form-control select2" id="specialfoods" name="specialfoods" style="width: 100%;"
            ...
            <div id="specialfoodsquantityd" class="form-group col-md-2">
                <label>Quantity</label>
                <input type="number" class="form-control" id="specialfoodsquantity" name="specialfoodsquantity" max=""
                    min="1" value="1">
            </div>
            <div id="specialfoodsqavailabled" class="form-group col-md-2">
                <label>Max Quantity Available</label>
                <input type="number" class="form-control" id="specialfoodsqavailable" name="specialfoodsqavailable"
                    readonly value="">
            </div>
            <div id="specialfoodspriced" class="form-group col-md-2">
                <label>Price ($)</label>
                <input type="number" class="form-control" id="specialfoodsprice" name="specialfoodsprice" readonly
                    value="">
            </div>
            @endif
            ...
            <div class="form-group col-md-10">
                ...
                <div class="radio">
                    <label id="del">
                        <input type="radio" class="minimal" name="mealmethod" style="clear: none; width: auto;"
                            id="optionsRadios1" value="delivery" @if($deduction->Patron_Deduction_Status == 0) disabled
                        @endif >
                        Get meal delivered
                    </label>
                </div>
                ...
                <div class="radio">
                    <label>
                        <input type="radio" class="minimal" name="mealmethod" style="clear: none; width: auto;"
                            id="optionsRadios2" value="pick-up" checked>
                        Pick-up meal from restaurant
                    </label>
                </div>

            </div>
            <div class="has-error col-md-12" id="dwarn" name="dwarn"><span class="help-block">No delivery time
                    available. Either pick-up order from restaurant or change meal date.</span></div>
            <div id="delivery" name="delivery">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2" id="location_id" name="location_id" style="width: 100%;"
                        Required placeholder="Select location">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2" id="location_time" name="location_time" style="width: 100%;"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" class="form-control" name="meal_date" id="meal_date" value="{{date("Y-m-d")}}"
                        required>
                </div>
                <div class="has-error" id="cwarning" name="cwarning"><span class="help-block">The current order time has
                        exceeded the order cutoff time set for today, therefore you cannot order your meal(s) today.
                        Sorry for the inconvience caused.</span></div>
                <!-- /.input group -->
            </div>
            ...
            <input id="deduction" name="deduction" class="form-group col-md-12" style="display: none"
                value="{{$deduction->Patron_Deduction_Status}}">
        ...
        <div class="box-footer">
            ...
            <button type="submit" class="btn btn-success btn-flat pull-right">
                <li class="glyphicon glyphicon-floppy-disk"></li>Order
            </button>
        </div>
        <!-- /.box-footer -->
        </form>
