              ...
              <form id="orderform" role="form" method="POST" action="{{action('OrderController@confirm')}}" enctype="multipart/form-data">
			   @csrf
				...
				<div id="specialfoodsquantityd" class="form-group col-md-2">
				  <label>Quantity</label>
				  <input disabled type="number" class="form-control" id="specialfoodsquantity" name="specialfoodsquantity" max="" min="1" value="{{$special_id->Quantity}}">
				</div>
				<div id="specialfoodspriced" class="form-group col-md-2">
				  <label>Price($)</label>
				  <input type="number" class="form-control" id="specialfoodsprice" name="specialfoodsprice" disabled value="">
				</div>
				@endif
