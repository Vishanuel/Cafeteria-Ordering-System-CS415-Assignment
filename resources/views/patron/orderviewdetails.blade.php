      ...
      <div class="row">
        ...
        <div class="col-md-12">
		  <div class="box box-primary">
              ...
              <form id="orderform" role="form" method="POST" action="" enctype="multipart/form-data">
			   @csrf
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control" disabled readonly name="meal_da" id="meal_da" value="{{$cos_order->Cos_Meal_Date_Time}}" required>
                </div>
			...
			<input id="cwarning" name="cwarning" class="form-group col-md-12" style="display: none" value="">
			</div>
            <!-- /.box-body -->
