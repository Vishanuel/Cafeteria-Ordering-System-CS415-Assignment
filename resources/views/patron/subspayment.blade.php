        ...
        <div class="col-md-12">
		  <div class="box loading box-success">
            ...
            <div id="box" class="box-body">
              <form id="orderform" role="form" method="POST" action="{{action('MealSubsController@payment')}}" enctype="multipart/form-data">
			   @csrf
                <!-- text input -->
				...
				<div class="form-group">
					<div class="radio col-md-6">
						<label>
						  <input type="radio" class="minimal" name="mealmethod" id="optionsRadios1" value="payroll"  @if($deduction->Patron_Deduction_Status == 0) disabled @endif @if($mealmethod=="Delivery") checked @endif @if($deduction->Patron_Deduction_Status == 0) disabled @endif @if($mealmethod!="Delivery"&&$deduction->Patron_Deduction_Status != 0) checked @endif>
				...
				<div class="form-group">
					<div class="radio col-md-6 ">
						<label>
						  <input type="radio" class="minimal" name="mealmethod" id="optionsRadios3" value="card" @if($deduction->Patron_CardRegister_Status == 0) disabled @endif>
						  Card payment
						</label>
				    </div>
				</div>
				<div class="form-group">
					<div class="radio col-md-6 ">
						<label>
						  <input type="radio" class="minimal" name="mealmethod" id="optionsRadios2" value="cash" @if($mealmethod=="Delivery") disabled @endif @if($deduction->Patron_Deduction_Status == 0) checked @endif>
            ...
            <!-- /.box-body -->
			 <div class="box-footer">
				<div class="btn-toolbar">
					...
					<a href="{{URL::to('mealsub_edit_details/'.$mealsubs_id)}}"  class="btn btn-warning btn-flat pull-right"><li class="glyphicon glyphicon-pencil"></li> Edit</a>
                </div>	
