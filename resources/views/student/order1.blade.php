...
<section class="content-header" style="background-color:white; margin-top:114px">
        ...
        <ol class="breadcrumb" >
         ...
         <!--   <li><a href="{{url('featuretwo/#course')}}"><span class="glyphicon glyphicon-user"></span><strong> University Courses</strong></a></li> -->
            <li style="color:#283c78" class="active">Place Order</li>
        </ol>
      </section>
                                        ...
                                        <div class="row" style="background-color:white;">
                                            <div class="col-sm-12" style=" border-color:#e6e6e6; border-width:2px; border-style:solid; text-align:left;" >
                                                <div class="row" style="margin-top:3px; margin-bottom:5px;">
                                                    ...
                                                    <select class="col-sm-3" id="" name="food_item" style="margin-top:8px;">
                                                      <option id="food_item" Required name="food_item" Required value=""  disabled selected>Select Username</option>

                                                      @foreach ($foods as $food )
                                                          <option id="food_item" name="food_item" Required value="{{ $food->Menu_Food_Item_ID}}">
                                                          {{ $food->Food_Name}}
                                                          </option>
                                                     @endforeach
                                                    </select>
