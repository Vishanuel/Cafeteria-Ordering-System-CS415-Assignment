    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <!-- <li><a href="{{url('smpdevice')}}">Device</a></li> -->
		...
		<li><a target="_blank" href="{{url('help/OrderConfirmationPage.html')}}"><span class="glyphicon glyphicon-question-sign" style="font-size: 15px;"></span></a></li>
      </ol>
    </section>
<!-- Main content -->
		  ...
		  <div class="box loading box-success">
            ...
            <div id="box" class="box-body">
				...
				<div class="form-group col-md-6">
					  <div class="radio">
						<label>
						  <input type="radio" class="minimal" name="mealmethod3" id="optionsRadios2" value="cash" @if($cos_order->Cos_Order_Payment_Method=="cash") checked @else disabled @endif>
				...
				<div class="form-group">
					<div class="radio col-md-6 ">
						<label>
						  <input type="radio" class="minimal" name="mealmethod3" id="optionsRadios3" value="card" @if($deduction->Student_CardRegister_Status == 0) disabled @endif @if($cos_order->Cos_Order_Payment_Method=="card") checked @else disabled @endif>
						  Card payment
						</label>
				    </div>
				</div>
