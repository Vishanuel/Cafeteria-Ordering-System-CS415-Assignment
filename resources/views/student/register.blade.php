					...
					<div class="form-group col-md-6">
						<div class="radio ">
							<label for="payrollmethod">
							  <input type="radio" class="minimal" name="payrollmethod" id="payrollmethod" value="1" @if($payrollstat == 0) disabled @else required @endif @if($reg_patron->Patron_Deduction_Status == 1) checked required @endif > Register						  						
							</label>
						</div>					
					</div>
					...
					<div class="form-group col-md-6">
						<div class="radio ">
							<label for="payrollmethod2">
							  <input type="radio" class="minimal" name="payrollmethod" id="payrollmethod2" value="0" @if($payrollstat == 0) disabled @endif @if($reg_patron->Patron_Deduction_Status == 0) checked @endif > Unregister						
							</label>
						</div>
					</div>
				</div>
					...
					<div class="form-group col-md-6">
						<div class="radio">	
							<label for="cardmethod">
							  <input type="radio" class="minimal" name="cardmethod" id="cardmethod" value="1"  @if($reg_patron->Patron_CardRegister_Status == 1) checked @endif > Register		
							</label>
						</div>					
					</div>
					...
					<div class="form-group col-md-6 ">
						<div class="radio">
							<label for="cardmethod2">
							  <input type="radio" class="minimal"  name="cardmethod" id="cardmethod2" value="0" required @if($reg_patron->Patron_CardRegister_Status == 0) checked @endif > Unregister						
							</label>
						</div>					
					</div>
				</div>
			...
			<div class="col-md-6 col-xs-12 pull-left" >
				<div class="box box-default loading" >
					<div class="box-header with-border">
						...
						<button type="submit" data-barba-prevent="self" value="submit" class="btn btn-success btn-flat pull-right"><li class="glyphicon glyphicon-floppy-disk"></li>Submit</button>	
						</form>
					</div>	
				</div> 
			</div>
