    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <!-- <li><a href="<?php echo e(url('smpdevice')); ?>">Device</a></li> -->
		...
		<li><a target="_blank" href="<?php echo e(url('help/ViewingDetailedOrderInformation.html')); ?>"><span class="glyphicon glyphicon-question-sign" style="font-size: 15px;"></span></a></li>
      </ol>
    </section>
<!-- Main content -->
