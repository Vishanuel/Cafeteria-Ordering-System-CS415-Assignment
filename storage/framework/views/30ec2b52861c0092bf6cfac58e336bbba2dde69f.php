				   ...
				   <?php if($order->Cos_Order_Meal_Status == "Pending Delivery"): ?>
					<tr>
					  ...
					  <td style="text-overflow: ellipsis;" class="text-center">
						...
						<a class="btn btn-warning btn-flat btn-block" target="_blank" type="button" href="<?php echo e(URL::to('cafeteria/'.$order->Cos_Order_Num)); ?>">
							Print Delivery Info
						</a>
						<?php endif; ?>
						<?php if($order->Cos_Order_Meal_Status == "Pending Delivery"): ?>
						<a class="btn btn-success btn-flat btn-block" type="button" href="<?php echo e(URL::to('deliverer/'.$order->Cos_Order_Num.'/edit')); ?>">
							Meal Delivered
						</a>
						<?php endif; ?>		
						</td>
...
<?php echo $__env->make('layouts.app_deliverer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\COS\resources\views/meal deliverer/orderviewall.blade.php ENDPATH**/ ?>